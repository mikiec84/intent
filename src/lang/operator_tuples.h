...
//TUPLE( number, precedence, associativity, name, example, comment )
  ...
  TUPLE( 0x0102, 1, left_to_right, ungroup, ")", "group" )
...
TUPLE( 0x0105, 1, left_to_right, spread, "*.", "spread across all members of a container" )
  ...
  TUPLE( 0X0114, 1, left_to_right, subscript_end, "]", "end of subscript")
...
TUPLE( 0x0203, 2, right_to_left, implied_positive_mark, "+?", "implied positive mark" )
  TUPLE( 0x0204, 2, right_to_left, implied_negative_mark, "-?", "implied negative mark" )
