...
EVENT(E_INPUT_FILE1_UNREADABLE, error, user, 2,
		"domain.base.input",
		"Input file %1{fname} is unavailable or unreadable. Check permissions"
		" and file name.",
		"")

EVENT(E_INPUT_FILE1_EMPTY, error, user, 3,
		"domain.base.input",
...
EVENT(E_FAILED_TO_LOCK_MUTEX_POSIX_ERROR1, fatal, internal, 5,
		"domain.base.internal",
...
EVENT(E_FAILED_TO_UNLOCK_MUTEX_POSIX_ERROR1, fatal, internal, 7,
		"domain.base.internal",
...
EVENT(E_PRECONDITION_EXPR1_VIOLATED, fatal, internal, 9,
		"domain.base.internal",
...
EVENT(E_CHECK_EXPR1_VIOLATED, fatal, internal, 10,
		"domain.base.internal",
...
EVENT(E_POSTCONDITION_EXPR1_VIOLATED, fatal, internal, 11,
		"domain.base.internal",
...
EVENT(E_ILLEGAL_CALL_IN_STATE_NAME1, error, internal, 12,
		"domain.base.internal",
...
EVENT(E_CMDLINE_MISSING_VALUE_FOR_OPTION1, error, user, 13,
		"domain.base.input",
		"Expected %1 option to be followed by a value.",
		"")

EVENT(E_CMDLINE_UNRECOGNIZED_SWITCH1, error, user, 14,
		"domain.base.input",
		"%1 looks like a switch of some kind, but is not recognized.",
		"")

EVENT(E_FILE1_BAD_HUGE_LINE_2BYTES, error, user, 15,
		"domain.base.input",
...
EVENT(E_FILE1_BAD_SEEMS_BINARY, error, user, 16,
		"domain.base.input",
		"Input file %1{fname} seems to be binary; it cannot be processed"
		" line-by-line.",
		"")

EVENT(I_APP1_STARTING, info, user, 17,
