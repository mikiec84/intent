#ifndef _FOUNDATION_XLOG_H_
#define _FOUNDATION_XLOG_H_
...
THREADSAFE // All handlers should be, but unenforceable... Implement accordingly.
...
/**
 * Tracing works the same way as logging, except that the audience is
