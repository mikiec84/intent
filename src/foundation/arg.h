#ifndef _FOUNDATION_INTERP_ARG_H_
#define _FOUNDATION_INTERP_ARG_H_
...
public:
	...
	arg(uint16_t value);
	arg(uint8_t value);
// CLANG considers long and unsigned long to be different datatypes from
// int64_t and uint64_t, whereas gcc considers them synonyms.
#ifdef __clang__
	arg(long value);
