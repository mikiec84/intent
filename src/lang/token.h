#ifndef _token_h_695ce797496541c9b74e67f9c5bfa6a1
#define _token_h_695ce797496541c9b74e67f9c5bfa6a1
...
public:
    ...
    token(token_type type, intent::core::sslice const & slice);
    ~token();
