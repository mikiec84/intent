...
def detect_available_sanitizers(compiler):
    possible = 'integer,undefined,unsigned-integer-overflow,address,thread,mem,dataflow'.split(',')
    folder = '/tmp' #tempfile.mkdtemp()
    available = []
    try:
        ...
        try:
            ...
            pass #os.remove(cpp_path)
        print(' '.join(available))
    finally:
        pass #os.rmdir(folder)
